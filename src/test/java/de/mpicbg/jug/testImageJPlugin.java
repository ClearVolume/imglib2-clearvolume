...
public class testImageJPlugin
{
	...
	{
		// final String fname =
		// "/Users/jug/Desktop/ClearVolumeDatasetSamples/XY.tif"; // OK
		// final String fname =
...
//		final String fname = "/Users/mweigert/Data/droso_test.tif";
		...
		// final String fname =
		// "/Users/jug/Desktop/ClearVolumeDatasetSamples/synthetic.tif";
		// final String fname =
		// "/Users/jug/Desktop/ClearVolumeDatasetSamples/synthetic_labels.tif";
		// final String fname =
		...
		try
		{
			...
			{
				ij.command()
					.run(	de.mpicbg.jug.plugins.ClearVolumePlugin.class,
								true,
								"dataset",
								img);
			}
