...
class RangeSliderUI extends BasicSliderUI
{
	...
	final private Color handleFillColor = Color.lightGray;
	final private Color handleColor = Color.darkGray;
	...
	public void paintTrack(Graphics g)
	{
		...
		if (slider.getOrientation() == JSlider.HORIZONTAL)
		{
			...
			for (int y = 0; y <= 3; y++)
			{
				g.drawLine(	lowerX - trackBounds.x,
										y,
										upperX - trackBounds.x,
										y);
			}
		...
		else
		{
			...
			{
				g.drawLine(	x,
										lowerY - trackBounds.y,
										x,
										upperY - trackBounds.y);
			}
	...
	private void setUpperThumbLocation(int x, int y)
	{
		...
		SwingUtilities.computeUnion(upperThumbRect.x,
																...
																upperUnionRect);
		slider.repaint(	upperUnionRect.x,
										upperUnionRect.y,
										upperUnionRect.width,
